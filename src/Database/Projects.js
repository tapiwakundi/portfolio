...
export const Projects = [
  ...
  },
  {
    ...
    description:
      "DermiGen is an organic skincare company that specializes in burn treatment creams. Unlike its competitors, it offers a cream with all natural ingredients and no side effects.",
    pageDescription:
    ...
    live: "https://www.dermigen.ca",
  },
  {
    id: "teamapp",
    name: "Teamapp Site",
    tags: ["Entrepeneaur", "Responsive", "Mentoring"],
    description:
      "Team App was a concept project for a team communication website. I made it through Webflow and took advantage of their powerful CMS platform to create a blog section that management can update on their timeline without a developer. This Application is fully responsive and highlights the foundational principles behind a reliable website for a growing company.",
    pageDescription:
      "Team App was a concept project for a team communication website. I made it through Webflow and took advantage of their powerful CMS platform to create a blog sect",
